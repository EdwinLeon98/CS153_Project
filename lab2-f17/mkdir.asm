...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1066:	c7 44 24 04 bb 18 00 	movl   $0x18bb,0x4(%esp)
    106d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1420:	0f b6 80 84 1b 00 00 	movzbl 0x1b84(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    157d:	75 09                	jne    1588 <printf+0x101>
          s = "(null)";
    157f:	c7 45 f4 d7 18 00 00 	movl   $0x18d7,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1649:	a1 a0 1b 00 00       	mov    0x1ba0,%eax
  ...
  freep = p;
    ...
    1714:	a3 a0 1b 00 00       	mov    %eax,0x1ba0
}
    1719:	c9                   	leave  
    171a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    176c:	a1 a0 1b 00 00       	mov    0x1ba0,%eax
}
    1771:	c9                   	leave  
    1772:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1788:	a1 a0 1b 00 00       	mov    0x1ba0,%eax
    178d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1790:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1794:	75 23                	jne    17b9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1796:	c7 45 f0 98 1b 00 00 	movl   $0x1b98,-0x10(%ebp)
    179d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    17a0:	a3 a0 1b 00 00       	mov    %eax,0x1ba0
    17a5:	a1 a0 1b 00 00       	mov    0x1ba0,%eax
    17aa:	a3 98 1b 00 00       	mov    %eax,0x1b98
    base.s.size = 0;
    17af:	c7 05 9c 1b 00 00 00 	movl   $0x0,0x1b9c
    17b6:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    180c:	a3 a0 1b 00 00       	mov    %eax,0x1ba0
      return (void*)(p + 1);
    ...
    if(p == freep)
    1819:	a1 a0 1b 00 00       	mov    0x1ba0,%eax
